...
// Studio (Home Page > Services). Nothing is auto-populated from the Service
// collection, so this section only ever shows exactly what's been curated.
export async function ServicesGridSection() {
  const homePage = await getHomePage()
  const section = homePage?.servicesGrid
